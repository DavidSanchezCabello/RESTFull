package com.dscode.notas.core.repository;
...
public interface NotaRepositorio extends JpaRepository<Nota, Serializable>, PagingAndSortingRepository<Nota, Serializable> {
	...
	// Gracias al siguiente método, conseguimos que se nos devuelva un objeto 'Page' que contendrá 
	// todas las notas de manera paginada tal y como hemos configurado en las application.properties
	// (en la URL deberemos añadir el formato deseado de paginación ej. http://localhost:8080/v1/notas?page=0&size=5) 
